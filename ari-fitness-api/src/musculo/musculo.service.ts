...
export class MusculoService {
   ...
   * @param {Musculo} body - The `body` parameter in the `create` function likely represents the data or
   * object of type `Musculo` that you want to insert into a database table. It contains the information
   ...
   * data.
   * @param body - The `body` parameter in the `update` function is a partial object of type `Musculo`.
